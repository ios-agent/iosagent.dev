...
• **backButton** - A button to display as the Back button on the navigation bar.
• **leadingNavigationBarButtons** - An array of bar buttons to display on the leading side of the navigation bar.
• **trailingNavigationBarButtons** - An array of bar buttons to display on the trailing side of the navigation bar.
• **CPBarButton** - A button for placement in a navigation bar.
• **CPMessageComposeBarButton** - A button that activates Siri and initiates the compose message flow.
...
### Siri Actions
• **CPAssistantCellActionType.playMedia** - Provides an action that uses Siri to prompt the user for media playback.
• **CPAssistantCellActionType.startCall** - Provides an action that uses Siri to prompt the user for a person, group, or business to call.
...
• **CPListItem.AssistantCellPosition.bottom** - Positions the assistant cell at the bottom of all visible cells.
• **CPListItem.AssistantCellPosition.top** - Positions the assistant cell at the top of all visible cells.
...
• **CPListItem.AssistantCellVisibility.off** - The assistant cell isn't visible.
• **CPListItem.AssistantCellVisibility.always** - The assistant cell is always visible.
• **CPListItem.AssistantCellVisibility.whileLimitedUIActive** - The assistant cell is visible only while Limited UI mode is active.
...
### Button Styles
• **CPBarButtonStyle.none** - A style that provides no additional styling.
• **CPBarButtonStyle.rounded** - A style that provides a rounded background.
...
### Initializers
• **init(image:showsImageFullHeight:title:subtitle:tintColor:)** - Initialize an element that is constituted of an image, boolean to entirely cover the element with th...

### Instance Properties
• **showsImageFullHeight** - A Boolean value indicating whether the element should be fill with the image.
• **subtitle** - The subtitle associated with this element.
• **tintColor** - A UIColor used to tint the element. When @c showsImageFullHeight is true, the tint color is applied ...
• **title** - The title associated with this element.

### Type Properties
• **maximumFullHeightImageSize** - The expected image size for the image in your @c CPListImageRowItemCardElement when @c showsImageFul...
• **maximumImageSize** - The expected image size for the image in your @c CPListImageRowItemCardElement when @c showsImageFul...
...
### Initializers
• **init(image:imageShape:title:subtitle:accessorySymbolName:)** - Initialize a list image row condensed element with an image, an image shape, a title, subtitle and a...

### Instance Properties
• **accessorySymbolName** - The name of the system symbol image to use as accessory.
• **imageShape** - Shape used to draw the image of the element.
• **subtitle** - The subtitle associated with this element.
• **title** - The title associated with this element.

### Enumerations
• **CPListImageRowItemCondensedElement.Shape** - Types of shape used to draw a condensed row element.
...
• **isEnabled** - A Boolean value indicating whether the list element is enabled.

### Type Properties
• **maximumImageSize** - The expected image size for the image in your @c CPListImageRowItemElement. Images provided will be ...
...
### Initializers
• **init(image:)** - Initialize an element that is constituted of an image.
...
### Initializers
• **init(image:imageShape:title:accessorySymbolName:)** - Initialize an element that is constituted of an image and an image shape.
...
### Enumerations
• **CPListImageRowItemImageGridElement.Shape** - Types of shape used to draw a list item.
...
### Initializers
• **init(image:title:subtitle:)** - Initialize an element that is constituted of an image, title and subtitle. Only image is required wh...
